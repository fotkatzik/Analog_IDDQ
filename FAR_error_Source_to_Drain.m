...
plotData = importdata('error13_enable_on.csv');
...
plotData2 = importdata('error13_enable_on_current.csv');
...
%% ENABLE OFF
% Normal operation conditions - DC Voltage outputs - Vddext enabled
plotData = importdata('error13_enable_off.csv');
...
plotData2 = importdata('error13_enable_off_current.csv');
...
plotData4 = importdata('error13_enable_on_current.csv');
...
text(x1 + 1, (y1+y2)/2 - 200, sprintf('ΔI = %g μA @ -40 oC', diff), 'HorizontalAlignment', 'left', 'VerticalAlignment', 'middle');
...
% Plot the line between the two points with the calculated difference
plot([x1 x1], [y4 y3], 'k--', 'LineWidth', 1);
text(x1 - 95, (y3+y4)/2 + 200 , sprintf('ΔI = %g μA @ 150 oC', diff), 'HorizontalAlignment', 'left', 'VerticalAlignment', 'middle');

% Plot circles at the start and end points
plot(x1, y3, 'ro', 'MarkerSize', 8, 'MarkerFaceColor', 'r'); % Circle at start point
plot(x1, y4, 'o', 'MarkerSize', 8, 'MarkerFaceColor', 'g', 'MarkerEdgeColor', 'g'); % Circle at end point
legend('', '', '')
legend(["VDDEXT faulty module enabled current" "VDDEXT module base current" ]);
...
% Plot the line between the two points with the calculated difference
plot([x1 x1], [y2 y1], 'k--', 'LineWidth', 1);
text(x1 + 1, (y1+y2)/2 - 100, sprintf('ΔI = %g μA @ -40 oC', diff), 'HorizontalAlignment', 'left', 'VerticalAlignment', 'middle');
...
% Plot the line between the two points with the calculated difference
plot([x1 x1], [y4 y3], 'k--', 'LineWidth', 1);
text(x1 - 95, (y3+y4)/2 + 100 , sprintf('ΔI = %g μA @ 150 oC', diff), 'HorizontalAlignment', 'left', 'VerticalAlignment', 'middle');
