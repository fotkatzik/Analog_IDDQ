...
plotData = importdata('error2_enable_on.csv');
...
plotData2 = importdata('error2_enable_on_current.csv');
...
%% ENABLE OFF
% Normal operation conditions - DC Voltage outputs - Vddext enabled
plotData = importdata('error2_enable_off.csv');
...
plotData2 = importdata('error2_enable_off_current.csv');
...
plotData4 = importdata('error2_enable_on_current.csv');
